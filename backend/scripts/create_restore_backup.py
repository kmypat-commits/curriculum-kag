...
INCLUDE_PATHS = [
    ...
    "backend/init_db.sql", "backend/init_db_data.py", "backend/seed_db.py",
    "backend/seed_investigator.py", "backend/seed_massive_210.py",
    "backend/seed_massive_210_en.py", "backend/.env", "backend/curriculum_kag.db",
