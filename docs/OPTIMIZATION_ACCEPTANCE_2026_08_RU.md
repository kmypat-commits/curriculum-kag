...
Снимок: 25.08.2026, после commit `8d171b2`. Статусы отражают проверяемое состояние,
а не намерение.
